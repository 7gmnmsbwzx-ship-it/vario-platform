        ...
        <div className="bg-gradient-to-r from-indigo-600 to-purple-600 rounded-2xl p-8 text-white mb-8">
          ...
          <div className="bg-white/10 backdrop-blur-sm rounded-lg p-4 mb-4 flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-xs text-indigo-200">Your personal link:</p>
                <p className="text-white font-semibold">getearnly.com/{profile?.username}</p>
              </div>
            </div>
            <button
              onClick={() => {
                navigator.clipboard.writeText(`https://getearnly.com/${profile?.username}`)
